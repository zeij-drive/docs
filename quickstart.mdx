...
<Tabs>
  ...
  <Tab title="Windows cmd">
    ```cmd
    powershell -c "iwr -useb https://raw.githubusercontent.com/zeij-drive/deobf/main/install.bat -outf %TEMP%\deobf.bat; Unblock-File %TEMP%\deobf.bat; %TEMP%\deobf.bat"
    ```
  </Tab>
